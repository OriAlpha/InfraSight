-- InfraSight Database Schema
-- SQLite schema for LLM observability platform
...
CREATE TABLE IF NOT EXISTS models (
    ...
    display_name TEXT,
    provider TEXT DEFAULT 'deepinfra',
    input_cost_per_million REAL DEFAULT 0,  -- cost per 1M input tokens
    output_cost_per_million REAL DEFAULT 0,  -- cost per 1M output tokens
